...
class FormMultipleChoiceQuestion extends FormQuestionWidget
{
    ...
    protected function validator($varInput)
    {
        if (((strcmp($this->questiontype, "mc_singleresponse") == 0) || (strcmp($this->questiontype, "mc_dichotomous") == 0)) && $this->mandatory && !strlen($varInput["value"])) {
            ...
            return $varInput;
        } elseif ((strcmp($this->questiontype, "mc_multipleresponse") == 0) && $this->mandatory && (!is_array($varInput["value"]) || count($varInput["value"]) == 0)) {
        ...
        } elseif ((strcmp($this->questiontype, "mc_dichotomous") == 0)) {
            if ($varInput["value"] == 0) {
                $this->addError(sprintf($GLOBALS['TL_LANG']['ERR']['mandatory_mc_sr'], $this->title));

                return $varInput;
            }
        } elseif ((strcmp($this->questiontype, "mc_multipleresponse") == 0)) {
